...
public class TaskAssignmentListener1 implements TaskListener {

	private static final String HOST = "smtp.gmail.com";
	private static final String USER = "arvind7238realcoderz@gmail.com";
	private static final String PWD = "Realcoderz7238@";
	private final static Logger LOGGER = Logger.getLogger(TaskAssignmentListener1.class.getName());
	...
	public void notify(DelegateTask delegateTask) {
		...
		if (assignee != null) {
			...
			try {
				...
				message.setContent("Please complete: http://localhost:8083/forms/Interview.html?taskId=" + taskId+ "&callbackUrl=http://localhost:8083/camunda/app/tasklist/default/#/","text/plain");
